...
# Add a title with red color and a subtitle
st.markdown(
    """
    <h1 style='color: red;'>Nhận dạng trái cây</h1>
    <h2 style='color: gray;'>Nhận dạng các 10 loại trái cây từ hình ảnh</h2>
    <h6 style='color: green;'>Bưởi | Cam vàng | Dâu | Thơm | Cherry | Dừa | Dưa hấu | Kiwi | Măng cụt | Carot</h6>
    """,
    unsafe_allow_html=True
)

# Load model and classes
model = 'utility/RecognitionFruit/best.onnx'

classes = ['buoi', 'cam_vang', 'chom_chom', 'dau', 'mang_cut', 'carot', 'cherry', 'duahau', 'kiwi', 'thom']
