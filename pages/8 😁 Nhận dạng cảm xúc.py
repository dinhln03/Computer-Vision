...
st.markdown(
    """
    <h1 style='color: red;'>Nhận dạng cảm xúc</h1>
    <h4 style='color: lime;'>Phát hiện và phân loại cảm xúc từ khuôn mặt</h4>
    <h8 style='color: navy;'>giận dữ | kinh tởm | sợ hãi | vui vẻ | bình thường | buồn bã | ngạc nhiên</h8>
    """,
